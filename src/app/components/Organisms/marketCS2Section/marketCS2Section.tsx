  ...
  return (
    <section className={styles.content}>
      ...
      <p className={styles.text}>
        ...
        по ссылке:{" "}
        <a target="_blank" href="https://market-cs2.vercel.app/">
        ...
        на странице "Инвентарь", где предметы можно фильтровать по различным
        критериям. <br />• Чат: Реализован с использованием базы данных SQLite
      </p>

  ...
  return (
    <section className={styles.content}>
      ...
      <p className={styles.text}>
        В процессе разработки интернет-магазина "Organick" я создал адаптивную
        вёрстку в точном соответствии с дизайн-макетом. Для достижения
        максимально точного соответствия дизайну применялись методы Pixel
        Perfect и PixelParallel, что позволило реализовать все элементы
